...
<body style="background: linear-gradient(135deg, #e8f5e9 0%, #f1f8e9 100%); min-height: 100vh;">
            ...
            <main class="col-md-10 ms-sm-auto px-5 py-4 position-relative dashboard-main">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4 animate-on-scroll fade-in-down dashboard-header-glass">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="fs-4 fw-bold" style="font-family: var(--heading-font); color: var(--heading-color); letter-spacing: 1px;">Contact Messages</span>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="col-md-4">
                            <div class="card dashboard-card-glass border-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="mt-3 mb-0 fw-bold text-success" id="totalMessages" style="font-size: 2.5rem;">0</h3>
                        ...
                        <div class="col-md-4">
                            <div class="card dashboard-card-glass border-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="mt-3 mb-0 fw-bold text-success" id="todayMessages" style="font-size: 2.5rem;">0</h3>
                        ...
                        <div class="col-md-4">
                            <div class="card dashboard-card-glass border-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="mt-3 mb-0 fw-bold text-success" id="weekMessages" style="font-size: 2.5rem;">0</h3>
    ...
    <style>
        ...
        .dashboard-card-glass:hover { box-shadow: 0 16px 48px 0 rgba(46,163,89,0.18); }
        ...
        @media (max-width: 991px) { 
            .sidebar-glass { border-radius: 0 0 32px 32px; min-height: auto; } 
            .dashboard-main { padding: 2rem 1rem !important; } 
        }
    </style>

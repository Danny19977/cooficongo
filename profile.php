            ...
            <main class="col-md-10 ms-sm-auto px-5 py-4 position-relative dashboard-main">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4 animate-on-scroll fade-in-down dashboard-header-glass">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="fs-4 fw-bold" style="font-family: var(--heading-font); color: var(--heading-color); letter-spacing: 1px;">My Profile</span>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <div class="card dashboard-card-glass hover-lift shadow-lg border-0 mb-4">
                                <div class="card-body">
                                    <h2 class="mb-3 fw-bold" style="font-family: var(--heading-font); color: var(--accent-color); letter-spacing: 1px;">
                                    ...
                                    <form action="php/updateprofile.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label for="profile_image" class="form-label fw-semibold">Profile Picture</label>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="card dashboard-card-glass hover-glow shadow border-0 animate-on-scroll fade-in-right mb-4">
                             ...
                             alt="Profile Picture" 
                                    ...
                                    <span class="badge bg-success bg-gradient px-3 py-2"><?php echo htmlspecialchars(ucfirst($user['role'])); ?></span>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-around mt-3">
                                        <div class="text-center">
                                            <span class="fs-4 fw-bold text-success"><?php echo $stats['posts']; ?></span><br>
                                            <span class="text-muted small">Posts</span>
                                        </div>
                                        <div class="text-center">
                                            <span class="fs-4 fw-bold text-success"><?php echo $stats['events']; ?></span><br>
                                            <span class="text-muted small">Events</span>
                                        </div>
                                        <div class="text-center">
                                            <span class="fs-4 fw-bold text-success"><?php echo $stats['views']; ?></span><br>

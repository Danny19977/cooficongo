                ...
                <div
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="fs-4 fw-bold"
                            style="font-family: var(--heading-font); color: var(--heading-color); letter-spacing: 1px;">Blog
                            Post</span>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="card dashboard-card-glass hover-lift shadow-lg border-0">
                                <div class="card-body">
                                    ...
                                    <form action="php/addpost.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label for="image_1" class="form-label fw-semibold">Additional Image
                                                1</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="image_2" class="form-label fw-semibold">Additional Image
                                                2</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="image_3" class="form-label fw-semibold">Additional Image
                                                3</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="blog" name="blog" rows="6"
                                                placeholder="Write your blog post here..." required></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-success btn-lg mt-2 shadow-sm"><i
                                                class="bi bi-upload me-2"></i>Submit Post</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="blogPostContainer">
                                        <?php if (!empty($blogPosts)): ?>
                                            <?php foreach ($blogPosts as $index => $post): ?>
                                                ...
                                                <div class="blog-post-item <?php echo $index > 0 ? 'd-none' : ''; ?>"
                                                    data-post="<?php echo $index + 1; ?>">
                                                    <div class="mb-2">
                                                    ...
                                                    <h5 class="fw-bold text-success">
                                                        <?php echo htmlspecialchars($post['title']); ?></h5>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            <button type="button" class="btn btn-sm btn-outline-primary"
                                                                onclick="editPost('<?php echo htmlspecialchars($post['uuid']); ?>')">
                                                                <i class="bi bi-pencil-square"></i> Edit
                                                            </button>
                                                            <button type="button" class="btn btn-sm btn-outline-danger"
                                                                onclick="deletePost('<?php echo htmlspecialchars($post['uuid']); ?>', '<?php echo htmlspecialchars(addslashes($post['title'])); ?>')">
                                    ...
                                    <?php if (!empty($blogPosts)): ?>
                                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                            <button class="btn btn-outline-success btn-sm" id="prevPost"
                                                onclick="navigatePosts(-1)">
                                                <i class="bi bi-arrow-left"></i> Previous
                                            </button>
                                            <span class="text-muted small fw-semibold">
                                                <span id="currentPost">1</span> / <span
                                                    id="totalPosts"><?php echo count($blogPosts); ?></span>
                                            </span>
                                            <button class="btn btn-outline-success btn-sm" id="nextPost"
                                                onclick="navigatePosts(1)">

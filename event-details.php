...
<body class="event-details-page">
  ...
  <header id="header" class="header d-flex align-items-center position-relative">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu stagger-animation">
        ...
        <nav class="desktop-nav">
          <ul class="nav-links">
            ...
            <!-- <li><a href="testimonials.html"><span data-i18n="nav.testimonials">Témoignages</span></a></li> -->
            ...
            <li><a href="gallery.html"><span data-i18n="nav.gallery">Galerie</span></a></li>
        ...
        <button class="mobile-nav-toggle d-xl-none" type="button" data-bs-toggle="modal" data-bs-target="#mobileNavModal" aria-label="Open navigation menu">
        ...
        <div class="modal-dialog modal-fullscreen-sm-down modal-dialog-scrollable">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="mobileNavLabel">Menu</h5>
            ...
            <div class="modal-body">
              <ul class="list-unstyled">
                ...
                <!-- <li><a href="testimonials.html" class="mobile-nav-link" data-bs-dismiss="modal"><i class="bi bi-chat-quote me-2"></i><span data-i18n="nav.testimonials">Témoignages</span></a></li> -->
                ...
                <li><a href="gallery.html" class="mobile-nav-link" data-bs-dismiss="modal"><i class="bi bi-images me-2"></i><span data-i18n="nav.gallery">Galerie</span></a></li>
      ...
      </div><!-- End Mobile Navigation Modal -->
  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        <h1 data-i18n="page.event_details">Détails de l'événement</h1>
        <p><?php echo htmlspecialchars($event['title']); ?></p>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.html" data-i18n="breadcrumbs.home">Accueil</a></li>
            <li><a href="activity.php" data-i18n="breadcrumbs.activities">Activités</a></li>
            <li class="current" data-i18n="breadcrumbs.event_details">Détails de l'événement</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-8">
          ...
          <div class="mt-4">
            <a href="activity.php" class="back-to-activities">
              <i class="bi bi-arrow-left me-2"></i><span data-i18n="event.back_to_activities">Retour aux activités</span>
            </a>
          </div>

            ...
            <nav class="col-md-2 d-none d-md-block sidebar-glass sidebar py-4 px-0 position-relative">
                <div class="sidebar-sticky d-flex flex-column align-items-center h-100">
                    <div class="text-center mb-4 mt-2 animate-on-scroll fade-in-down">
                        ...
                        <h5 class="mt-3 mb-0"
                            style="font-family: var(--heading-font); letter-spacing: 1px; color: white;">CooFICongo</h5>
                ...
                <div
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="fs-4 fw-bold"
                            style="font-family: var(--heading-font); color: var(--heading-color); letter-spacing: 1px;">Gallery
                            Management</span>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="card dashboard-card-glass hover-lift shadow-lg border-0">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-success border-0 shadow-sm mb-4"
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 small">
                                                    <strong>You're in control!</strong> Upload as many or as few photos
                                                    and videos as you want.
                                                    Only one image is required to create a gallery. All other fields are
                                                    completely optional.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <form action="php/addgallery.php" method="post" enctype="multipart/form-data"
                                        id="galleryForm">
                                        <div class="mb-3">
                                            <label for="category" class="form-label fw-semibold">Category / Album Name
                                                *</label>
                                            <input type="text" class="form-control" id="category" name="category"
                                                placeholder="e.g., Event Photos, Community Activities, etc." required>
                                            <div class="form-text">Enter a category or album name for this gallery
                                                collection</div>
                                        </div>

                                        <!-- Image Uploads Section -->
                                        <div class="mb-4">
                                            <h5 class="mb-3"><i class="bi bi-card-image text-success me-2"></i>Images
                                                (At least 1 required, up to 10 total)</h5>
                                            <div class="alert alert-info py-2 mb-3">
                                                <i class="bi bi-info-circle me-2"></i>
                                                <small>Upload as many or as few images as you want. Only the first image
                                                    is required.</small>
                                            </div>
                                            <div class="row g-3">
                                                <?php for ($i = 1; $i <= 10; $i++): ?>
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="file" id="image_<?php echo $i; ?>"
                                                            name="image_<?php echo $i; ?>" accept="image/*" <?php echo $i == 1 ? 'required' : ''; ?>>
                                                    </div>
                                                <?php endfor; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            <h5 class="mb-3"><i class="bi bi-play-circle text-primary me-2"></i>Videos
                                                (All Optional - Up to 10)</h5>
                                            <div class="alert alert-info py-2 mb-3">
                                                <i class="bi bi-info-circle me-2"></i>
                                                <small>Videos are completely optional. Upload only if you have video
                                                    content to share.</small>
                                            </div>
                                            <div class="row g-3">
                                                <?php for ($i = 1; $i <= 10; $i++): ?>
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="file" id="video_<?php echo $i; ?>"
                                                            name="video_<?php echo $i; ?>" accept="video/*">
                                                    </div>
                                                <?php endfor; ?>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="galleryContainer">
                                        <?php if (!empty($galleries)): ?>
                                            <?php foreach ($galleries as $index => $gallery): ?>
                                                ...
                                                <div class="gallery-item <?php echo $index > 0 ? 'd-none' : ''; ?>"
                                                    data-gallery="<?php echo $index + 1; ?>">
                                                    <div class="mb-3">
                                                        <?php
                                                        ...
                                                        <?php if ($firstImage): ?>
                                                            <img src="<?php echo htmlspecialchars($firstImage); ?>"
                                                                class="img-fluid rounded mb-3" alt="Gallery preview"
                                                                style="max-height: 200px; width: 100%; object-fit: cover;"
                                                                onerror="this.src='assets/img/logo.png'">
                                                        <?php endif; ?>
                                                    </div>
                                                    <h5 class="fw-bold text-success">
                                                        <?php echo htmlspecialchars($gallery['category']); ?></h5>
                                                    <p class="text-muted small mb-2">
                                                        <i class="bi bi-images me-1"></i>
                                                        <?php
                                                        $imageCount = 0;
                                                        for ($i = 1; $i <= 10; $i++) {
                                                            if (!empty($gallery['image_' . $i]))
                                                                $imageCount++;
                                                        }
                                                        echo $imageCount;
                                                        ?> Images
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <button type="button" class="btn btn-sm btn-outline-primary flex-fill"
                                                            onclick="editGallery('<?php echo htmlspecialchars($gallery['uuid']); ?>')">
                                                            <i class="bi bi-pencil-square"></i> Edit
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-danger flex-fill"
                                                            onclick="deleteGallery('<?php echo htmlspecialchars($gallery['uuid']); ?>', '<?php echo htmlspecialchars(addslashes($gallery['category'])); ?>')">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="text-center py-4">
                                                ...
                                                <p class="text-muted">No gallery items yet. Upload your first collection!
                                                </p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php if (!empty($galleries)): ?>
                                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                            <button class="btn btn-outline-success btn-sm" id="prevGallery"
                                                onclick="navigateGalleries(-1)">
                                                <i class="bi bi-arrow-left"></i> Previous
                                            </button>
                                            <span class="text-muted small fw-semibold">
                                                <span id="currentGallery">1</span> / <span
                                                    id="totalGalleries"><?php echo count($galleries); ?></span>
                                            </span>
                                            <button class="btn btn-outline-success btn-sm" id="nextGallery"
                                                onclick="navigateGalleries(1)">

                ...
                <div
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="fs-4 fw-bold"
                            style="font-family: var(--heading-font); color: var(--heading-color); letter-spacing: 1px;">Event
                            Post</span>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="php/addevent.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" class="btn btn-success btn-lg mt-2 shadow-sm"><i
                                                class="bi bi-upload me-2"></i>Submit Event</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="eventContainer">
                                        <?php if (!empty($activitiesPosts)): ?>
                                            <?php foreach ($activitiesPosts as $index => $event): ?>
                                                ...
                                                <div class="event-item <?php echo $index > 0 ? 'd-none' : ''; ?>"
                                                    data-event="<?php echo $index + 1; ?>">
                                                    <h5 class="fw-bold text-success">
                                                        <?php echo htmlspecialchars($event['title']); ?></h5>
                                                    <p class="text-muted small mb-2">
                                                        <i class="bi bi-calendar-event me-1"></i>Date:
                                                        <?php echo htmlspecialchars($event['activity_date']); ?>
                                                        <br><i class="bi bi-geo-alt me-1"></i>Location:
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            <button type="button" class="btn btn-sm btn-outline-primary"
                                                                onclick="editEvent('<?php echo htmlspecialchars($event['uuid']); ?>')">
                                                                <i class="bi bi-pencil-square"></i> Edit
                                                            </button>
                                                            <button type="button" class="btn btn-sm btn-outline-danger"
                                                                onclick="deleteEvent('<?php echo htmlspecialchars($event['uuid']); ?>', '<?php echo htmlspecialchars(addslashes($event['title'])); ?>')">
                                    ...
                                    <?php if (!empty($activitiesPosts)): ?>
                                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                            <button class="btn btn-outline-success btn-sm" id="prevEvent"
                                                onclick="navigateEvents(-1)">
                                                <i class="bi bi-arrow-left"></i> Previous
                                            </button>
                                            <span class="text-muted small fw-semibold">
                                                <span id="currentEvent">1</span> / <span
                                                    id="totalEvents"><?php echo count($activitiesPosts); ?></span>
                                            </span>
                                            <button class="btn btn-outline-success btn-sm" id="nextEvent"
                                                onclick="navigateEvents(1)">
        ...
        function deleteEvent(uuid, title) {
            if (confirm(`Are you sure you want to delete the event "${title}"?\n\nThis action cannot be undone.`)) {
                ...
                fetch(`php/deleteevent.php?uuid=${uuid}`, {
                    ...
                    .then(data => {
                        if (data.success) {
                            window.location.href = 'event.php?success=event_deleted';
                        } else {
                            messageContainer.innerHTML = `
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
